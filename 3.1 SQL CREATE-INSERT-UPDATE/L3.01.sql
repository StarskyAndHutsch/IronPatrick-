...
SELECT * FROM bank.account
WHERE account_ide = '11382';


SELECT * FROM bank.account; -- convert date into datetime
SELECT * FROM bank.card; -- 
SELECT * FROM bank.client; --
SELECT * FROM bank.disp; --
SELECT * FROM bank.district; -- reame all columns
...
UPDATE accountDemo set location =
  ...
  ELSE 'south'
  END
  WHERE account_id > 0; -- hack to eliminate the save mode
